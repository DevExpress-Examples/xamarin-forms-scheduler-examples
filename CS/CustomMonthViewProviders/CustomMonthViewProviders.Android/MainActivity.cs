...
namespace CustomMonthViewProviders.Droid {
    [Activity(Label = "CustomMonthViewProviders", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
